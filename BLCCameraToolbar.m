...
- (instancetype) initWithImageNames:(NSArray *)imageNames {
    ...
    if (self) {
        ...
        //left and right buttons change functionality?
...
- (void) layoutSubviews {
    ...
    //purpleView is the camera button in the middle w/ rounded corners

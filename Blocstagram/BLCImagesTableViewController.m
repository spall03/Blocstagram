...
- (void)viewDidLoad
{
    ...
    //are image sources available? if so, create new camera button for the navbar to switch into camera mode
...
//put away keyboard if a cell is selected
...
- (void) cell:(BLCMediaTableViewCell *)cell didTapImageView:(UIImageView *)imageView {
    ...
    //choose modal presentation style based on screen size
    if (isPhone) {
...
//move comment view around relative to keyboard showing / hiding
...
//reverse these changes when the keyboard hides
